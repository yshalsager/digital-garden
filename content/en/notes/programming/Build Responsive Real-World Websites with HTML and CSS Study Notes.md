...
1. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#Typography|Typography]]
2. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#Colors|Colors]]
3. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#Images/Illustrations|Images/Illustrations]]
4. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#Icons|Icons]]
5. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#Shadows|Shadows]]
6. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#Border-radius|Border-radius]]
7. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#White Space|White Space]]
8. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#Visual Hierarchy|Visual Hierarchy]]
9. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#User Experience|User Experience]]
10. [[Build Responsive Real-World Websites with HTML and CSS Study Notes#Components/Layout|Components/Layout]]

### Typography

#### Serif vs Sans-serif

![[./CSS Typography#^df4a8f|CSS Typography > ^df4a8f]]
![[./CSS Typography#^f8e4fb|CSS Typography > ^f8e4fb]]
...
![[../../../img/Pasted image 20220522155721.png|Pasted image 20220522155721.png]]
...
1. Make the main color **match your website’s personality**: colors convey meaning!
   - <mark style="background: #FF5582A6;">Red</mark> draws a lot of attention, and symbolizes power, passion, and excitement.
   - <mark style="background: #FFB86CA6;">Orange</mark> is less aggressive, and conveys happiness, cheerfulness, and creativity.
   - <mark style="background: #FFF3A3A6;">Yellow</mark> means joy, brightness, and intelligence.
   - <mark style="background: #BBFABBA6;">Greens</mark> represents harmony, nature, growth, and health.
   - <mark style="background: #ADCCFFA6;">Blue</mark> is associated with peace, trustworthiness, and professionalism.
   - <mark style="background: #D2B3FFA6;">Purple</mark> conveys wealth, wisdom, and magic.
   - <mark style="background: #FFB8EBA6;">Pink</mark> represents romance, care, and affection.
   - <mark style="background: brown;">Brown</mark> is associated with nature, durability and comfort.
   - <mark style="background: #CACFD9A6;">Black</mark> symbolizes power, elegance and minimalism, but also grief and sorrow.
...
8. Accordion
   - [[../../../img/01-accordion.html|01-accordion.html]]
9. Tabs
10. Carousel
    - [[../../../img/02-carousel.html|02-carousel.html]]
...
### [[./CSS Vertical Centering With Absolute Position and Transform|CSS Vertical Centering With Absolute Position and Transform]]
...
- [[./CSS Global Reset|CSS Global Reset]]
- [[./CSS Reusable Grid|CSS Reusable Grid]]
- [[./CSS Make Image Color Grey|CSS Make Image Color Grey]]
- [[./CSS Add border inside element|CSS Add border inside element]]
- [[./CSS Vertical Centering With Absolute Position and Transform|CSS Vertical Centering With Absolute Position and Transform]]
- [[./CSS Change rem unit default value|CSS Change rem unit default value]]
- [[./CSS Focus better handling|CSS Focus better handling]]
- [[./CSS Simple link hover animation|CSS Simple link hover animation]]
- [[./CSS Hide Element|CSS Hide Element]]
- [[./CSS Create mobile navigation version from desktop one|CSS Create mobile navigation version from desktop one]]
- [[./CSS Smooth scrolling|CSS Smooth scrolling]]
- [[./CSS Sticky navigation with JavaScript|CSS Sticky navigation with JavaScript]]
