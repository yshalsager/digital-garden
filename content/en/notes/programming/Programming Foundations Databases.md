...
المدة:: 1h25m
المعرفة:: [[البرمجة|البرمجة]], [[Databases|Databases]]
المنشيء:: Scott Simpson
المهام:: [[Programming Foundations Databases 2|Programming Foundations Databases 2]], [[Programming Foundations Databases|Programming Foundations Databases]], [[Programming Foundations Databases|Programming Foundations Databases]]
الموضوع:: Databases
...
اﻷهداف:: [[LinkedIn Software Developer Path|LinkedIn Software Developer Path]], [[Full Stack MERN Path|Full Stack MERN Path]]
